    ...
    return [
        ...
        },
        {
            ...
            jsonSchema: {
                ...
                properties: {
                    workoutId: { type: 'string', minLength: 1 },
                    exerciseName: { type: 'string', minLength: 1, description: 'Name of the exercise to replace. Provide either exerciseName or exerciseId.' },
                    exerciseId: { type: 'string', minLength: 1, description: 'ID of the exercise to replace. Provide either exerciseName or exerciseId.' },
                    idempotencyKey: { type: 'string', minLength: 1, maxLength: 128 },
                    constraints: {
                        type: 'object',
                        additionalProperties: false,
                        properties: {
                            ...
                            injuries: {
                                ...
                                maxItems: 20,
                                items: { type: 'string', minLength: 1 },
                                description: 'List of injuries or limitations to avoid.',
                            },
