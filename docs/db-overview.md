...
├── exercises        (319 docs) ← מאגר תרגילים עם וידאו
...
| **exercises** | 319 | ✅ פעיל + הורחב | [db-exercises.md](db-exercises.md) |
...
| ✅ בוצע | עדכון 89 תרגילים עם movement_type=null | exercises |
| 🟡 גבוה | סגירת sessions שנשארו `active` | workoutsessions |
| 🟡 גבוה | תרגום ~90 תרגילים חסרי name_he | exercises |
